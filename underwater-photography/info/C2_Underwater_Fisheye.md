...
---
## The Single-Strobe Single-Exposure Strategy (HF-1 + Dome Diffuser)
1. **Positioning Geometry:** Keep the strobe arm pushed high and pulled **behind the plane of your housing handles**. Turn the strobe head slightly outward ("toe-out"). This lets the massive 160° hemispherical beam wrap forward without leaking directly into the dome glass, eliminating backscatter.
2. **The "Flash-Off" Ambient Cheat:** If you encounter a wide vista or silhouette opportunity beyond 2 meters (where flash fails), do not use menus. Simply click the physical power switch on the HF-1 to **OFF**. The camera instantly drops to clean ambient exposure tracking; open your front dial to f/4 or f/5.6 to let natural light in.
3. **The "Black Background" Trigger:** If water visibility plunges, rotate your rear dial directly to **1/250s** (the camera's maximum mechanical flash sync ceiling). This clips ambient light by roughly 1.3 stops, forcing a messy green background to drop into black shadow while the strobe sharply isolates the foreground subject.