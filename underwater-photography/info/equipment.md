# Photography Equipment Inventory
...
* Backscatter Hybrid Flash (HF-1) [SKU: BABSHF1]
    * HF-1 White 140° Flat Diffuser
    * Backscatter HF-1 White Dome Diffuser
    * XTAR 21700HP 5000mAh 25A batteryset (2pc)
* Backscatter Mini Flash 2 (MF-2)
    * Backscatter Optical Snoot OS-1 [SKU: BABSOS1]
    * Nitecore 21700 Battery (NL2153HP): 5300mAh
* Backscatter OM Smart Control Flash Trigger [SKU: BABSTROM1D]
...
## Rig
* Nauticam Carbon Float Arm (90 x 150)
* WeeFine 5" Ball Arms (x4)
* Nauticam Standard Clamp [#72501]
* WeeFine Float Block Set FLEX 600 (580g total buoyancy)
